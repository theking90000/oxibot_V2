...
const handleData = (store) => {
    return store.Modules.find(c => c.id === store.ChangeGuild.guild.id) || { noGuild: true }
}
...
const EditModule = (props: any) => {
    ...
    if (props.noGuild || !props.modules.find(x => x.name === props.module_name)) {
   ...
   React.useEffect(() => {
    ...
    const HandleDisable = async () => {
        ...
        const payload = await SetModuleEnabled({ ServerID: props.id, name: module.name, value: !enabled })
